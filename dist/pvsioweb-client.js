 ...
 * /
  ...
  define('util/eventDispatcher', ['require', 'exports', 'module'], function (require, exports, module) {
  ...
  define('util/uuidGenerator', ['require', 'exports', 'module'], function (require, exports, module) {
  ...
  define('websockets/events', ['require', 'exports', 'module'], function (require, exports, module) {
  ...
  !function () {
    ...
    d3.layout.treelist = function () {
      ...
      var hierarchy = d3.layout.hierarchy().sort(null).value(null), nodeHeight = 20, childIndent = 20, size;
      function treelist(d, i) {
        var nodes = hierarchy.call(this, d, i), root = nodes[0];
        function visitAll(f, t, index, parent) {
          if (t) {
            f(t, index, parent);
          }
          ...
          if (children && children.length) {
            children.forEach(function (child, ci) {
              visitAll(f, child, ci, t);
            });
          }
        }
        function layout(node) {
          var x = 0, y = 0;
          visitAll(function (n, index, parent) {
      ...
      return d3_layout_hierarchyRebind(treelist, hierarchy);
    };
    d3.random = {
      normal: function (µ, σ) {
        var n = arguments.length;
  ...
  define('PVSioWebClient', ['require', 'exports', 'module', 'websockets/pvs/pvsWSClient', 'util/eventDispatcher', 'd3/d3', 'util/property'], function (require, exports, module) {
    ...
    var pvsws = require("websockets/pvs/pvsWSClient"),
      ...
      url = window.location.origin.indexOf("file") === 0 ?
        ("ws://localhost") : ("ws://" + window.location.hostname + "/pvs"),
      instance;
